    ...
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          {jobs.length > 0 && (
            <span className="bg-green-500/20 text-green-400 dark:text-green-400 text-xs px-2 py-0.5 rounded-full">
      ...
      <div className="p-3">
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground/60 text-xs mt-1">Create a new job to get started</p>
          </div>
        ) : (
  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <p className="text-sm font-medium text-foreground truncate">{job.job_number}</p>
        ...
        {job.client_name && (
          <p className="text-xs text-muted-foreground/60 mt-0.5 truncate">{job.client_name}</p>
        )}
      </div>
      {job.start_date && (
