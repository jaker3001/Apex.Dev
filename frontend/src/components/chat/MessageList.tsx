      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-2 max-w-xl">
          {[
            ...
            <button
              key={prompt}
              className="px-4 py-2.5 text-left text-sm text-muted-foreground hover:text-foreground border border-border/50 rounded-lg hover:border-border hover:bg-muted/50 transition-colors"
            >
              {prompt}
            </button>
          ))}
